...
class Matrix4 {
    ...
    static extractRotation(m) {
        ...
        const me = m.elements;
        const scaleX = 1 / Vector3_1.default.fromMatrixColumn(m, 0).length();
        const scaleY = 1 / Vector3_1.default.fromMatrixColumn(m, 1).length();
        const scaleZ = 1 / Vector3_1.default.fromMatrixColumn(m, 2).length();
        te[0] = me[0] * scaleX;
        te[1] = me[1] * scaleX;
        te[2] = me[2] * scaleX;
        te[3] = 0;
    ...
    inverse(m = Matrix4.identity()) {
        const te = new Matrix4(), me = m.elements, n11 = me[0], n21 = me[1], n31 = me[2], n41 = me[3], n12 = me[4], n22 = me[5], n32 = me[6], n42 = me[7], n13 = me[8], n23 = me[9], n33 = me[10], n43 = me[11], n14 = me[12], n24 = me[13], n34 = me[14], n44 = me[15], t11 = n23 * n34 * n42 -
            n24 * n33 * n42 +
            n24 * n32 * n43 -
            n22 * n34 * n43 -
            n23 * n32 * n44 +
    ...
    static makeRotationFromQuaternion(q) {
        return Matrix4.compose(new Vector3_1.default(0, 0, 0), q, new Vector3_1.default(1, 1, 1));
    }
    ...
    decompose() {
        const te = this.elements;
        const position = new Vector3_1.default();
        const sx = new Vector3_1.default(te[0], te[1], te[2]).length();
        const sy = new Vector3_1.default(te[4], te[5], te[6]).length();
        const sz = new Vector3_1.default(te[8], te[9], te[10]).length();
        // if determine is negative, we need to invert one scale
        const det = this.determinant();
        const scale = new Vector3_1.default((det < 0) ? -sx : sx, sy, sz);
        position.x = te[12];
        position.y = te[13];
        position.z = te[14];
        ...
        const quaternion = Quaternion_1.default.fromRotationMatrix(matrix);
