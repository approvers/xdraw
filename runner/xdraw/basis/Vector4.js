...
class Vector4 {
     ...
     * @memberof Vector4
     */
    static fromQuaternionToAxisAngle(q) {
    ...
    static fromRotationMatrixToAxisAngle(m) {
    ...
    clampScalar(minVal, maxVal) {
        return this.clamp(new Vector4(minVal, minVal, minVal, minVal), new Vector4(maxVal, maxVal, maxVal, maxVal));
    }
    clampLength(min, max) {
