...
class Ray {
    constructor(origin = new Vector3_1.default(), direction = new Vector3_1.default(), maxDistance = Infinity) {
        this.origin = origin;
        this.direction = direction;
        this.maxDistance = maxDistance;
        this.segCenter = new Vector3_1.default();
        this.segDir = new Vector3_1.default();
        this.diff = new Vector3_1.default();
    }
    clone() {
    ...
    intersectedPointWithTriangle(f, cullBackface = false) {
        ...
        let DdN = this.direction.dot(normal), sign = 1;
        if (DdN < 0) {
            sign = -1;
            DdN = -DdN;
        }
    ...
    intersectsWithTriangle(f, cullBackface = false) {
    ...
    distanceSqToSegment(vStart, vEnd, interRay, interSegment) {
