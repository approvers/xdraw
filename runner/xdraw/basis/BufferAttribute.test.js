...
const BufferAttribute_1 = require("./BufferAttribute");
...
test('copyArray', () => {
    ...
    const buffer = new BufferAttribute_1.default(array, 3, false);
    const dst = new Float32Array(4);
    buffer.copyArray(dst);
    expect(dst).toEqual(array);
});
test('copyColorsArray', () => {
    const buffer = new BufferAttribute_1.default(new Float32Array(6), 3);
    buffer.copyColorsArray([
        Color_1.default.rgb(0, 0.5, 1),
        Color_1.default.rgb(0.25, 1, 0)
    ]);
    expect(buffer.array).toEqual(new Float32Array([0, 0.5, 1, 0.25, 1, 0]));
});
test('copyVector2sArray', () => {
    const buffer = new BufferAttribute_1.default(new Float32Array(4), 2);
    buffer.copyVector2sArray([
        new Vector2_1.default(1, 2),
        new Vector2_1.default(4, 5)
    ]);
    expect(buffer.array).toEqual(new Float32Array([1, 2, 4, 5]));
});
test('copyVector3sArray', () => {
    const buffer = new BufferAttribute_1.default(new Float32Array(6), 2);
    buffer.copyVector3sArray([
        new Vector3_1.default(1, 2, 3),
        new Vector3_1.default(10, 20, 30)
    ]);
    expect(buffer.array).toEqual(new Float32Array([1, 2, 3, 10, 20, 30]));
});
test('copyVector4sArray', () => {
    const buffer = new BufferAttribute_1.default(new Float32Array(8), 2);
    buffer.copyVector4sArray([
        new Vector4_1.default(1, 2, 3, 4),
        new Vector4_1.default(10, 20, 30, 40)
    ]);
...
test('set[X, Y, Z, W, XYZ, XYZW]/get[X, Y, Z, W]', () => {
    ...
    const a = new BufferAttribute_1.default(f32a, 4, false);
...
test('setXY', () => {
    ...
    const a = new BufferAttribute_1.default(f32a, 2, false);
...
test('setXYZ', () => {
    ...
    const a = new BufferAttribute_1.default(f32a, 3, false);
...
test('clone', () => {
    const attr = new BufferAttribute_1.default(new Float32Array([1, 2, 3, 4, 0.12, -12]), 2);
...
test("count", () => {
    expect(new BufferAttribute_1.default(new Float32Array([1, 2, 3, 4, 5, 6]), 3).count).toEqual(2);
});
