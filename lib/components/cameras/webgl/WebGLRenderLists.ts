...
export class WebGLRenderList {
  ...
  push(transform: Transform, mesh: Mesh | null, material: Material, z: number) {
    ...
    (material.props.transparent === true ? this.transparent : this.opaque).push(renderItem);
  ...
  unshift(transform: Transform, mesh: Mesh | null, material: Material, z: number) {
    ...
    (material.props.transparent === true ? this.transparent : this.opaque).unshift(renderItem);
